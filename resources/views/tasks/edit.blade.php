...
<div class="sd" style="margin: 50px  100px 0 200px;">
    <form action="{{ route('tasks.update',$task->id) }}" method="post">
        <fieldset>
            <legend style="direction: rtl;width: 500px;text-align: center" class="mylabel">ویرایش یادداشت :</legend>
    <input type="hidden" name="_method" value="PATCH">
        ...
        <div class='col-sm-6'>
        <label for="title" class="mylabel">نام یادداشت:</label>
        <input class="input-medium" type="text" name="title" value="{{$task->title}}"/>
            <div class="form-group">
                <div class='input-group' id='start'>
                    <label for="start" class="mylabel">تاریخ شروع یادداشت:</label>
            ...
            <div class="form-group">
                <div class='input-group' id='end'>
                    <label for="end" class="mylabel">تاریخ پایان یادداشت:</label>
            ...
            <a class="btn btn-danger" href="{{route('tasks.delete',$task->id)}}">حذف یادداشت</a>
        </div>
		<div class='col-sm-3'></div>
        </div>
        </div>
