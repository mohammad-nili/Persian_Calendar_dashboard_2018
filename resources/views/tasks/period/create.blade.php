...
<form action="{{ route('termPeriod.create') }}" method="post">
    ...
    <div class="container sd" style="padding: 20px; margin-top: 50px;width: 600px;height: 200px">
        <fieldset>
            <legend style="direction: rtl;width: 600px;text-align: center" class="mylabel">تعیین تاریخ شروع و پایان :</legend>
        <div class="row">
            <div class='col-sm-3'></div>
            <div class='col-sm-6'>
                <div class="form-group">
                    <div class='input-group' id='start'>
                        <input type='text' class="form-control" name="start" placeholder="تاریخ شروع ترم" value=""/>
                ...
                <div class="form-group">
                    <div class='input-group' id='end'>
                        <input type='text' class="form-control" name="end" placeholder="تاریخ پایان ترم" value=""/>
                        <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                    </div>
